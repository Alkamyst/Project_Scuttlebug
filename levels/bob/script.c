...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		WARP_NODE(0xF1, LEVEL_CASTLE_GROUNDS, 0x01, 0x32, WARP_NO_CHECKPOINT),
		WARP_NODE(0x32, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x01, LEVEL_BOB, 0x02, 0x03, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 3961, 135, -6641, 0, 90, 0, (4 << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -3, 313, 2333, 0, -90, 0, 0x00F10000, bhvFadingWarp),
		OBJECT(MODEL_NONE, 3201, 242, -6643, 0, -90, 0, (1 << 16), bhvWarp),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, -252, 238, 2130, 0, -180, 0, (50 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, -328, 202, -5706, 0, -25, 0, (49 << 16), bhvMessagePanel),
	...
	AREA(2, bob_area_2),
		...
		WARP_NODE(0x32, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x02, LEVEL_BOB, 0x01, 0x04, WARP_NO_CHECKPOINT),
		WARP_NODE(0x03, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_EXCLAMATION_BOX, 9163, 7324, -1123, 0, 0, 0, 0x00050000, bhvExclamationBox),
		OBJECT(MODEL_BLUE_COIN_SWITCH, 5782, 5984, -1097, 0, -7, 0, 0x00000000, bhvBlueCoinSwitch),
		OBJECT(MODEL_BLUE_COIN, 6396, 6104, -1157, 0, -7, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 6965, 6012, -1255, 0, -7, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 7422, 6087, -884, 0, -7, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 7976, 5984, -1060, 0, -7, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_NONE, 1264, 6602, -539, 0, 90, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 1264, 6602, 533, 0, 90, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 4993, 6998, 8, 0, -180, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 9159, 6998, 8, 0, -180, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 2876, 6125, -775, 0, -180, 0, (17 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 10864, 5858, 14, 0, -180, 0, (17 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 6900, 5634, 1, 0, -180, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_PARAGOOMBA, 4979, 7295, -1154, 0, 162, 0, 0x00000000, bhvParagoomba),
		OBJECT(MODEL_PARAGOOMBA, 6520, 6812, 1103, 0, -71, 0, 0x00000000, bhvParagoomba),
		OBJECT(MODEL_PARAGOOMBA, 11583, 7331, -17, 0, 98, 0, 0x00000000, bhvParagoomba),
		OBJECT(MODEL_PARAGOOMBA, 4351, 6142, -886, 0, 119, 0, 0x00000000, bhvParagoomba),
		OBJECT(MODEL_PARAGOOMBA, 10377, 6562, -679, 0, 109, 0, 0x00000000, bhvParagoomba),
		OBJECT(MODEL_BOBOMB_BUDDY, 2903, 6350, -223, 0, 111, 0, (0 << 16), bhvBobombBuddy),
		OBJECT(MODEL_PIPLUP, 11639, 5858, 29, 0, -99, 0, 0x00000000, bhvBobombBuddyOpensCannon),
		OBJECT(MODEL_NONE, 6906, 5967, -1, 0, 0, 0, (4 << 24) | (1 << 8), bhvHiddenParagoombaStar),
		OBJECT(MODEL_NONE, 746, 6922, 0, 0, -90, 0, (3 << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 2115, 7335, 1, 0, 90, 0, (2 << 16), bhvWarp),
