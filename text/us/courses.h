COURSE_ACTS(COURSE_BOB, _("   SCUTTLEBUG CAVERN"),
       _("NATHANIEL SCUTTLEBUG BANDY")    , _("SOME SIMPLE FLIPS")             , _("SECRETS OF THE CAVERN"),
       _("TREASURED 8 RED COINS")         , _("NATHANIEL'S SECRET STAR")       , _("THE BOAT'S TOP"))
